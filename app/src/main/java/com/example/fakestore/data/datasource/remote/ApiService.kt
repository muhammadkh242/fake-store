...
import com.example.fakestore.data.model.UserCart
...
interface ApiService {
    ...
    @GET("/carts/{id}")
    suspend fun getCartProducts(@Path("id") id: Int): Response<UserCart>

    @GET("/users/{id}")
    suspend fun getUserProfile(@Path("id") id: Int): Response<UserData>
}